    ...
    <div class="inner">
      <div class="cart_a fadeUpTrigger">
        ...
        <div class="cart_item d-f js-sb">
          ...
          <div class="cart_e">
            <p class="cart_1"><?php echo $cakeName; ?></p>
            <p class="cart_2">SIZE：<?php echo $uProduct['size']; ?></p>
            <form action="cart.php" method="post">
              <input type="hidden" name="delete_name" value="<?php echo $cakeName; ?>">
              <button type="submit" class="cart_3">削除する</button>
            </form>
          </div>
          <div class="cart_e-0 d-f">
            <div class="cart_e-1 cc1"><?php echo $price; ?></div>
            <div class="cart_e-2 cc1"><?php echo $uProduct['number']; ?></div>
            <div class="cart_e-3 cc1"><?php echo $subtotal; ?>円</div>
          </div>
        </div>
        <!-- /.cart_item -->
        <div class="cart_atr d-f js-sb">
          ...
          <div class="cart_j d-f fd-c ai-c">
            ...
            <div class="cart_i">
              ...
              <div class="btn-7 ww">
                <a href="sp_ch-maccha.php">買い物を続ける</a>
              </div>
            </div>
