  ...
  <div class="container">
    ...
    <form id="main_contact" method="post" action="confirm.php">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control validate mail required" id="email" name="email" placeholder="Email アドレス"
      ...
      <div class="form-group">
        ...
        <input type="text" class="validate max30 tel form-control" id="tel" name="tel" value="<?php echo h($tel); ?>"
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control validate max100 required" id="subject" name="subject" placeholder="件名"
